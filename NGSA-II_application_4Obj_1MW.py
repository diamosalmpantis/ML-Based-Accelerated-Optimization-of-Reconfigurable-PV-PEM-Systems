# -*- coding: utf-8 -*-
"""NGSA-II for 4 Obj_1MW.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/10s-l5O-AEZKweTlwTfUFu89cUdbgsVPC
"""
    ...
    for hour, (irradiance, temperature) in enumerate(zip(hourly_averaged_irradiance_values, hourly_averaged_temperature_values), 1):
        ...
        if res.F is not None and len(res.F) > 0:
            ...
            for i, (f1, f2, f3, f4) in enumerate(res.F):
                ...
                plt.xticks(np.arange(0, x_max + 1, 50))
...
df_summary.to_csv("nsga2_summary_1MW.csv", index=False)
print("Summary CSV saved to nsga2_summary_1MW.csv")
...
for i, method in enumerate(methods):
    ...
    axes[i, 0].set_yticks(np.arange(260,550, 36))
    axes[i, 0].grid(False)
